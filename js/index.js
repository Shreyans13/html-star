...
languages["Tools"] = ["Visual Code", "Android Studio", "Git", "Codespaces"];
languages["Frontend"] = ["VueJS", "React"];
languages["Backend"] = ["Node JS", "Express JS"];
languages["Databases"] = ["MongoDB"];
languages["Frameworks"] = ["Vuetify", "Bootstrap"];
...
var categoryData = force.nodes().filter(function (d) {
  if (d.category == "yes") {
    return d;
  }
});

var leafData = force.nodes().filter(function (d) {
  if (d.category != "yes") {
    return d;
  }
});
